...
export async function fetchGallery(mode: string, cursor?: string, signal?: AbortSignal, location?: string, spaceSlug = 'primary', token?: string | null, limit?: number, seed?: number): Promise<GalleryResponse> {
