...
@media (max-width: 680px) { .detail-panel { bottom: calc(42px + env(safe-area-inset-bottom)); max-height: min(70svh, 520px); padding: 10px 12px 16px; right: 12px; width: min(360px, calc(100vw - 24px)); } .detail-header { gap: 8px; } .detail-tabs { flex: 1 1 auto; gap: 2px; min-width: 0; overflow-x: auto; scrollbar-width: none; } .detail-tabs::-webkit-scrollbar { display: none; } .detail-tabs button { flex: 0 0 auto; font-size: 11px; padding: 8px 10px; } .detail-card { min-height: 80px; padding: 10px 11px; } .detail-card dd { overflow-wrap: anywhere; } .detail-rating .stars { margin-top: 14px; } .location-map-wrap { height: 180px; } }
</style>
