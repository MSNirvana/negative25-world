...
@media (max-width: 600px) { .view-heading h2 { font-size: 31px; }.view-heading p { line-height: 1.5; }.preview-heading { align-items: flex-start; flex-direction: column; gap: 5px; }.completion-note { align-items: flex-start; flex-direction: column; gap: 7px; }.history-row { align-items: flex-start; flex-direction: column; gap: 6px; }.history-count { padding-left: 0; white-space: normal; }.history-detail { padding-left: 10px; }.detail-row { display: grid; gap: 6px; }.detail-row > div { min-width: 0; }.detail-row strong { overflow-wrap: anywhere; white-space: normal; }.detail-ok { margin-left: 0; }.history-publish-bar { align-items: flex-start; flex-direction: column; }.confirm-action, .retry-action, .publish-action { min-height: 40px; } }
</style>
