...
.admin-shell { display: grid; gap: 70px; grid-template-columns: 220px minmax(0, 1fr); padding-bottom: calc(90px + env(safe-area-inset-bottom)); padding-top: 54px; }.admin-sidebar { border-right: 1px solid var(--line); min-height: calc(100vh - 150px); min-height: calc(100dvh - 150px); padding-right: 30px; }.back { align-items: center; background: transparent; color: var(--muted); display: inline-flex; font-size: 12px; gap: 6px; min-height: 40px; padding: 0; }.back:hover { color: var(--ink); }.admin-title { padding: 54px 0 38px; }.admin-title h1 { font-size: 31px; letter-spacing: -.04em; margin: 8px 0 0; }.workspace-picker { display: block; margin-top: 19px; }.workspace-picker select { background: var(--surface); border: 1px solid var(--line); border-radius: 4px; color: var(--ink); font-size: 12px; min-height: 40px; max-width: 188px; padding: 8px 26px 8px 9px; width: 100%; }nav { display: grid; gap: 5px; }nav a { align-items: center; border-radius: 4px; color: var(--muted); display: flex; font-size: 13px; gap: 10px; min-height: 40px; padding: 10px 9px; }nav a:hover, nav a.active { background: var(--surface-soft); color: var(--ink); font-weight: 650; }.admin-content { min-width: 0; padding-top: 10px; }.workspace-error { color: #a34d4d; font-size: 12px; margin: 0 0 18px; }
@media (max-width: 760px) { .admin-shell { display: block; padding-top: 28px; }.admin-sidebar { border-bottom: 1px solid var(--line); border-right: 0; min-height: 0; padding: 0 0 19px; }.admin-title { padding: 27px 0 18px; }nav { display: flex; gap: 3px; overflow-x: auto; padding-bottom: 2px; scrollbar-width: none; }nav::-webkit-scrollbar { display: none; }nav a { flex: 0 0 auto; } .admin-content { padding-top: 32px; } }
</style>
