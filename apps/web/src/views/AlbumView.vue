...
function open(photo: GalleryPhoto): void { gallery.openPhoto(photo, photos.value); void router.push({ path: `/photo/${photo.id}`, query: { ...route.query, space: gallery.spaceSlug } }); }
onMounted(load);
watch(albumId, load);
</script>
